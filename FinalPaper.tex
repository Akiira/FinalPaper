...
\begin{figure}[h!]
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Coverage ratios of the entire algorithm,  \label{fig:finalResultEntireAlgCoverageAlt}}
\end{figure}
...
\begin{center}
	\begin{tabular}{| l | c | c | c | c |}
		...
		HiLo & 1.42857 & 0 & 1.14958 \\ \hline
		Medium-Hard-One & 0.198628 & 0 & 26.5636 \\ \hline
		Triangle & 1.29762 & 0 & 6.08553 \\ \hline
		Medium-Hard-Two & 0.19234 & 0 & 34.7523 \\ \hline
		Hard & 0.194872 & 0 & 95.5332 \\ \hline
		ParameterTest & 0.75 & 0 & 0 \\ \hline
	\end{tabular}
\end{center}
