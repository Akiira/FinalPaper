...
\begin{comment}
Im gona make some cuts in this first paragraph. Most of what it says can be nice summarized by a table like we did for problem set one. I may throw it in the appnedix like we did then too, since this is not terribly important.

Also, I read that you shouldn't interpret/discuss the results in the results section, just give them. Then discuss everything in the following discussion section. Because of that I was considering moving the second paragraph the the discussion section and rewording everything to make it fit but i'm not sure if i want to do this yet and would like your oppinion on it. 

The stuff I have been reading about writing techincal papers has been coming from: http://abacus.bates.edu/~ganderso/biology/resources/writing/HTWtoc.html

The 'Results' section is talked about:
