...
Since no particular set of parameters seemed to prevail of others, we chose to run our final tests somewhat arbitrarily with a population size of 25, 0.5 mutation probability, and 2 cut points. In order to further investigate the efficacy of the various operators, three categories of final tests were performed on each of the CFGs. First, we evaulated each CFG against the entire algorithm as described above. Then, to determine if in fact the genetic operators were capable of finding good test cases on their own, we evaluated each CFG against the algorithm without any calls to either local optimization heuristic. Finally, to determine the effectiveness of the local optimization alone, we cut out all calls to test case and test suite crossover and mutation, as well as range adaption to test only the initial range search, population initialization, and local optimization operations.
...
\begin{center}
	\begin{tabular}{| l | c | c | c | c |}
		...
		%Test Case Source Report: (Avg. Size of final suite: 6.660000)
		%	Initial Population:           5.080000 (76.276276%)
		%	TestSuiteMutation:            0.040000 (0.600601%)
		%	TestCaseCrossoverAndMutation: 1.540000 (23.123123%)
		...
		%Test Case Source Report: (Avg. Size of final suite: 14.020000)
		%	Initial Population:           11.320000 (80.741797%)
		%	TestSuiteMutation:            0.040000 (0.285307%)
		%	TestCaseCrossoverAndMutation: 2.660000 (18.972896%)
		%	LocalOptFromParameters:       0.000000 (0.000000%)
		%	LocalOptFromZero:             0.000000 (0.000000%)
		...
		%Test Case Source Report: (Avg. Size of final suite: 18.820000)
		%	Initial Population:           8.880000 (47.183847%)
		%	TestSuiteMutation:            0.060000 (0.318810%)
		%	TestCaseCrossoverAndMutation: 9.880000 (52.497343%)
		%	LocalOptFromParameters:       0.000000 (0.000000%)
		%	LocalOptFromZero:             0.000000 (0.000000%)
		Hard & 0.564103 & 0.46 & 1208.94 & 17.9978 \\ \hline
		%Test Case Source Report: (Avg. Size of final suite: 27.580000)
		%	Initial Population:           12.680000 (45.975344%)
		%	TestSuiteMutation:            4.040000 (14.648296%)
		%	TestCaseCrossoverAndMutation: 10.860000 (39.376360%)
		%	LocalOptFromParameters:       0.000000 (0.000000%)
		%	LocalOptFromZero:             0.000000 (0.000000%)
	\end{tabular}
\end{center}
\caption{Final Results, No Local Optimization \label{fig:finalResultNoLocalOpt}}
\end{figure}
